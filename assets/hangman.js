...
var messageObject = {
  ...
  "ammit" :  "<h3>Ammit</h3><br><strong>Egypt</strong><br>Goddess with a lion, hippo, and crocodile body. She eats the impure hearts of the souls of the dead, condemning them to be restless forever.",
...
//player inputs an event.key to compare to lettersInMonster
document.onkeyup = function(event) {
  test=true;
  var letterGuessed = event.key;
  for(var i = 0; i < onceLetter.length; i++){
    if(letterGuessed === onceLetter[i] && test === true) {
       //remove one letter at the index that matches the letter guessed in the //alphabet array
